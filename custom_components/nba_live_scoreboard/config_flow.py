...
class NbaLiveScoreboardConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    VERSION = 1
    ...
    async def async_step_user(self, user_input: dict | None = None) -> FlowResult:
        ...
        schema = vol.Schema(
            {
                vol.Required(CONF_TEAM, default="NY"): vol.In(sorted(NBA_TEAM_MAP.keys())),
    ...
    ) -> NbaLiveScoreboardOptionsFlow:
        return NbaLiveScoreboardOptionsFlow()
...
class NbaLiveScoreboardOptionsFlow(config_entries.OptionsFlow):
