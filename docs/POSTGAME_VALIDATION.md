# NBA postgame-window validation
...
All **672 tests passed**. This repository contributed 191 Python and 63 JavaScript tests. Ruff, JavaScript syntax checks, and `git diff --check` also passed in every repository.
...
Captured regulation fixtures supplied explicit ESPN end-of-game markers. For NBA, `tests/fixtures/summary_401809234_regulation.json` yielded `2025-10-23T01:42:40Z`. This is the ESPN-reported marker timestamp, not a guarantee of the actual final-whistle time.
